...
**[v4.0.2 リリース](https://github.com/runceel/markdstage/releases/tag/v4.0.2)** を指定して
...
現在の **[v4.0.2 リリース](https://github.com/runceel/markdstage/releases/tag/v4.0.2)** には、
...
**Microsoft Store:** v4.0.2 の GitHub リリース後に提出予定です（近日公開）。
