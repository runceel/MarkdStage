...
**[v4.1.0 リリース](https://github.com/runceel/markdstage/releases/tag/v4.1.0)** を指定して
...
現在の **[v4.1.0 リリース](https://github.com/runceel/markdstage/releases/tag/v4.1.0)** には、
...
**Microsoft Store:** v4.1.0 の GitHub リリース後に提出予定です（近日公開）。
