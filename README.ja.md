...
**[v4.0.1 リリース](https://github.com/runceel/markdstage/releases/tag/v4.0.1)** を指定して
...
現在の **[v4.0.1 リリース](https://github.com/runceel/markdstage/releases/tag/v4.0.1)** には、
...
**Microsoft Store:** v4.0.1 の GitHub リリース後に提出予定です（近日公開）。
