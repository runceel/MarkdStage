...
- Name: editing/architecture-canvas.spec.mjs >> adding connectors and deleting nodes preserves reference integrity
- Location: test/editing/architecture-canvas.spec.mjs:508:1
