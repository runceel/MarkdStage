...
- Name: editing/architecture-canvas.spec.mjs >> keyboard controls the context menu and closing returns focus to the target
- Location: test/editing/architecture-canvas.spec.mjs:1022:1
