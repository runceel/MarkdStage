...
- Name: editing/architecture-canvas.spec.mjs >> importing an image from the computer numbers duplicate names and diagram undo keeps the asset
- Location: test/editing/architecture-canvas.spec.mjs:575:1
