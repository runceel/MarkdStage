...
- Name: editing/architecture-canvas.spec.mjs >> reloading source Markdown does not carry over a draft from the old generation
- Location: test/editing/architecture-canvas.spec.mjs:653:1
