...
- Name: editing/architecture-canvas.spec.mjs >> large diagrams scroll and pan to the edges, then fit centered in the viewport
- Location: test/editing/architecture-canvas.spec.mjs:431:1
