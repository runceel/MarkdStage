...
- Name: editing/architecture-canvas.spec.mjs >> blank space in the element tree adds near the visible canvas without overlap
- Location: test/editing/architecture-canvas.spec.mjs:820:1
