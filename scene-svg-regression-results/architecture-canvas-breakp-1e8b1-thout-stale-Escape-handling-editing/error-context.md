...
- Name: editing/architecture-canvas.spec.mjs >> breakpoint changes preserve the focused panel without stale Escape handling
- Location: test/editing/architecture-canvas.spec.mjs:356:1
