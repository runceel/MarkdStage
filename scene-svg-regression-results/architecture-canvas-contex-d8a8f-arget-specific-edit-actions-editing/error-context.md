...
- Name: editing/architecture-canvas.spec.mjs >> context menus on the canvas and element tree expose target-specific edit actions
- Location: test/editing/architecture-canvas.spec.mjs:735:1
