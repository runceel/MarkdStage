...
- Name: editing/architecture-canvas.spec.mjs >> a delayed stale state response does not roll back the generation after reload
- Location: test/editing/architecture-canvas.spec.mjs:673:1
