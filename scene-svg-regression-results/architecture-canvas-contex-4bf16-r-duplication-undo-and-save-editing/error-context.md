...
- Name: editing/architecture-canvas.spec.mjs >> context menus support ordering, connector duplication, undo, and save
- Location: test/editing/architecture-canvas.spec.mjs:787:1
