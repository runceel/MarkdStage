...
scope. To install the current **[v3.8.2 release](https://github.com/runceel/markdstage/releases/tag/v3.8.2)**
...
>
> `https://github.com/runceel/markdstage/tree/v3.8.2/.github/extensions/markdstage`
...
**[v3.8.2 release](https://github.com/runceel/markdstage/releases/tag/v3.8.2)** includes portable
builds and SHA-256 checksum files for Windows x64 and ARM64:

- [MarkdStage-win-x64.zip](https://github.com/runceel/markdstage/releases/download/v3.8.2/MarkdStage-win-x64.zip)
- [MarkdStage-win-arm64.zip](https://github.com/runceel/markdstage/releases/download/v3.8.2/MarkdStage-win-arm64.zip)
