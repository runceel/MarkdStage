...
[v4.2.6 release](https://github.com/runceel/markdstage/releases/tag/v4.2.6).

## Use the canvas Extension

When you open this repository as a project, `.github/extensions/markdstage/` loads at project
scope. To install the current **[v4.2.6 release](https://github.com/runceel/markdstage/releases/tag/v4.2.6)**
...
>
> `https://github.com/runceel/markdstage/tree/v4.2.6/.github/extensions/markdstage`
