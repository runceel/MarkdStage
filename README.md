...
scope. To install the current **[v3.6.0 release](https://github.com/runceel/markdstage/releases/tag/v3.6.0)**
...
**[v3.6.0 release](https://github.com/runceel/markdstage/releases/tag/v3.6.0)** includes portable
