...
scope. To install the current **[v3.7.0 release](https://github.com/runceel/markdstage/releases/tag/v3.7.0)**
...
**[v3.7.0 release](https://github.com/runceel/markdstage/releases/tag/v3.7.0)** includes portable
